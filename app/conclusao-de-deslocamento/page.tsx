...
return (
    <div>
        ...
        <Frm.TextArea label="Código da Solicitação de Deslocamento:" name="solicitacao_codigo" width={12} />
        <Frm.TextArea label="Data da Solicitação de Deslocamento:" name="solicitacao_data" width={12} />
...
return (
    <div>
        ...
        <label>Data da Solicitação de Deslocamento: </label>{' '}{solicitacao_data || "Não informado"}<br></br>
